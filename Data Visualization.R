...
barplot(table(data_frame$Brand), las=2, col="steelblue", main="Count of Cars by Brand")
par(mfrow=c(1,3))
barplot(table(data_frame$FuelType), col="orange", main="Fuel Type Distribution")
...
#We now create the correlation matrix and view heat map
